...
public class CreatePstByApi extends BaseApiTest {
    private String actualToken;
    private ApiHelper apiHeleper = new ApiHelper();
    private Faker faker = new Faker();

    @Before
    public void getTokenAndDeletePosts(){
        actualToken = apiHeleper.getToken();
        apiHeleper.deleteAllPostsTillPresent(TestData.VALID_LOGIN_API, actualToken);
    ...
    public void createPostByApi(){
        ...
        softAssertions
                .assertThat(apiHeleper.getAllPostsByUserRequest(TestData.VALID_LOGIN_API)
    ...
    private int getNumberOfPosts() {
        return  apiHeleper.getAllPostsByUserRequest(TestData.VALID_LOGIN_API)
