...
public class DataBaseTest {
    ...
    public void setUpDB() throws SQLException, ClassNotFoundException {
        ...
        logger.info("MySQL_Database connection established successfully.");
    }

    @After
    public void tearDownDB() throws SQLException {
        mySQLDatabase.quit();
        logger.info("MySQL_Database connection closed successfully.");
    }
    ...
    public void testDataFromDataBase() throws SQLException, ClassNotFoundException {
        ...
        final String LOGIN = "G12_viktoriiakrain";
        ...
        int numberOfAffectedRows =
                mySQLDatabase.changeTable("INSERT INTO seleniumTable VALUES('219313','%s','%s')", LOGIN, "123456");
